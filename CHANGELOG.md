...
- Fixed the `policy-checks` GitHub Actions workflow to install `actionlint` via the official `rhysd/actionlint` download script into a writable runner-local bin directory and export it to `PATH`.
